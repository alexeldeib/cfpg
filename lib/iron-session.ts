...
export type IronSession<T> = T & {
     ...
     */
    readonly save: (res: ResponseType, saveOptions?: OverridableOptions) => Promise<void>
}
...
export function createGetIronSession(
    ...
    return async function getIronSession<T extends {} = {}>(
        ...
        Object.defineProperties(session, {
            save: {
                value: async function save(newRes: ResponseType, saveOptions?: OverridableOptions) {
                    if ('headersSent' in newRes && newRes.headersSent) {
                        throw new Error(
            ...
            destroy: {
                value: async function destroy(newRes: ResponseType, destroyOptions?: OverridableOptions) {
